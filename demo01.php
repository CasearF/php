      ...
      <form action="demo01.php" method="post">
         <table>
            ...
            <tr>
               <td class="a">橘子</td>
               <td>
                  <input style="background-color: rgb(151, 151, 151);width: 300px;" type="number" name="juzi">
               </td>
               <td class="a">7.99</td>
            </tr>
            <tr>
               <td class="a">香蕉</td>
               <td>
                  <input style="background-color: rgb(151, 151, 151);width: 300px;" type="number" name="xiangjiao">
               </td>
               <td class="a">6.89</td>
            </tr>
            <tr>
               <td class="a">苹果</td>
               <td>
                  <input style="background-color: rgb(151, 151, 151);width: 300px;" type="number" name="pinguo">
               </td>
               <td class="a">3.99</td>
            </tr>
            <tr>
            ...
            <tr>
               ...
               <td class="a" style="    border:0px solid #000;">
                  <?php {
                     ...
                     function sum($juzi, $xiangjiao, $pinguo)
                     {   //定义一个函数，接收$juzi,$xiangjiao,$pinguo三个变量的数值
